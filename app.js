...
const STANDINGS_URLS = {
  NFL: 'https://site.web.api.espn.com/apis/v2/sports/football/nfl/standings?level=3&sort=winpercent:desc,playoffseed:asc',
  NBA: 'https://site.web.api.espn.com/apis/v2/sports/basketball/nba/standings?level=3&sort=gamesbehind:asc,winpercent:desc',
  MLB: 'https://site.web.api.espn.com/apis/v2/sports/baseball/mlb/standings?level=3&sort=gamesbehind:asc,winpercent:desc',
  WBC: 'https://site.web.api.espn.com/apis/v2/sports/baseball/wbc/standings',
  NHL: 'https://site.web.api.espn.com/apis/v2/sports/hockey/nhl/standings?level=3&sort=points:desc,winpercent:desc,playoffseed:asc',
  EPL: 'https://site.web.api.espn.com/apis/v2/sports/soccer/eng.1/standings?sort=rank:asc',
  'La Liga': 'https://site.web.api.espn.com/apis/v2/sports/soccer/esp.1/standings?sort=rank:asc',
  Bundesliga: 'https://site.web.api.espn.com/apis/v2/sports/soccer/ger.1/standings?sort=rank:asc',
  'Serie A': 'https://site.web.api.espn.com/apis/v2/sports/soccer/ita.1/standings?sort=rank:asc',
  'Ligue 1': 'https://site.web.api.espn.com/apis/v2/sports/soccer/fra.1/standings?sort=rank:asc',
  'UEFA CL': 'https://site.web.api.espn.com/apis/v2/sports/soccer/UEFA.CHAMPIONS/standings?sort=rank:asc',
  'UEFA EL': 'https://site.web.api.espn.com/apis/v2/sports/soccer/UEFA.EUROPA/standings?sort=rank:asc',
  'UEFA Conference League': 'https://site.web.api.espn.com/apis/v2/sports/soccer/UEFA.EUROPA.CONF/standings?sort=rank:asc',
  'World Cup': 'https://site.web.api.espn.com/apis/v2/sports/soccer/FIFA.WORLD/standings?sort=rank:asc',
  MLS: 'https://site.web.api.espn.com/apis/v2/sports/soccer/usa.1/standings?sort=rank:asc',
  NWSL: 'https://site.web.api.espn.com/apis/v2/sports/soccer/usa.nwsl/standings?sort=rank:asc',
  USL: 'https://site.web.api.espn.com/apis/v2/sports/soccer/USA.USL.1/standings?sort=rank:asc',
  'USL Super League': 'https://site.web.api.espn.com/apis/v2/sports/soccer/usa.w.usl.1/standings?sort=rank:asc',
  NCAAB: 'https://site.web.api.espn.com/apis/v2/sports/basketball/mens-college-basketball/standings?group=50&sort=playoffseed:asc,vsconf_winpercent:desc,vsconf_wins:desc,vsconf_losses:asc,vsconf_gamesbehind:asc&includestats=playoffseed,vsconf,vsconf_gamesbehind,vsconf_winpercent,total,winpercent,home,road,streak,vsaprankedteams,vsusarankedteams',
